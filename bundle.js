...
/* harmony import */ var _models_model_card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/model-card */ "./src/models/model-card.js");
/* harmony import */ var _models_model_comment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/model-comment */ "./src/models/model-comment.js");
...
class API {
  ...
  getCards() {
    return this._load({url: `movies`})
      .then(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["toJSON"])
      .then(_models_model_card__WEBPACK_IMPORTED_MODULE_2__["default"].parseCards);
  }
  ...
  updateCard({id, data}) {
    return this._load({
      ...
      .then(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["toJSON"])
      .then(_models_model_card__WEBPACK_IMPORTED_MODULE_2__["default"].parseCard);
  }

  getComments({id}) {
    return this._load({url: `comments/${id}`})
      .then(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["toJSON"])
      .then(_models_model_comment__WEBPACK_IMPORTED_MODULE_3__["default"].parseComments);
  }
  ...
  _load({url, method = _utils_constants__WEBPACK_IMPORTED_MODULE_0__["Method"].GET, body = null, headers = new Headers()}) {
    ...
    return fetch(`${this._endPoint}/${url}`, {method, body, headers})
      .then(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["checkStatus"])
      .catch((err) => {
        ...
        ${this._comments.map((comment) => `<li class="film-details__comment">
            ...
            <div>
              ...
              <p class="film-details__comment-info">
                ...
                <span class="film-details__comment-day">${moment__WEBPACK_IMPORTED_MODULE_3___default()(comment.date).fromNow()}</span>
  ...
  _subscribeOnEvents() {
    this.getElement().querySelectorAll(`.film-details__emoji-label`).forEach((element) => {
      element.addEventListener(`click`, () => {
        ...
        this.getElement().querySelector(`.film-details__add-emoji-label`).appendChild(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_2__["createElement"])(`<img src="${imageElement.src}" width="55" height="55" alt="emoji">`));
      });
    });
  }
}
...
class ProfileRating extends _abstract_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(cards) {
    super();
    this._cards = cards;
  }
  ...
  getTemplate() {
    return `<section class="header__profile profile">
      <p class="profile__rating">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["getUserTitle"])(this._cards.filter((card) => card.isWatched).length)}</p>
...
class SearchNoResult extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
/***/ "./src/components/statistic-filters.js":
/*!*********************************************!*\
  !*** ./src/components/statistic-filters.js ***!
  \*********************************************/
/*! exports provided: default */
...
class StatisticFilters extends _abstract_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  getTemplate() {
    ...
    <p class="statistic__rank">
      ...
      <span class="statistic__rank-label">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["getUserTitle"])(this._cards.filter((card) => card.isWatched).length)}</span>
    </p>
...
/***/ "./src/components/statistics-text.js":
/*!*******************************************!*\
  !*** ./src/components/statistics-text.js ***!
  \*******************************************/
/*! exports provided: default */
...
class Statistics extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _getTopGenre() {
    ...
    const sortedGenres = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["countDuplicateElements"])(watchedGenres);
...
class UserRating extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/constants */ "./src/utils/constants.js");
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/utils */ "./src/utils/utils.js");
/* harmony import */ var _components_comments_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/comments-form */ "./src/components/comments-form.js");
...
/* harmony import */ var _models_model_comment__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/model-comment */ "./src/models/model-comment.js");
...
class CommentsController {
  constructor(container, id, callback, onDataChange) {
    ...
    this._commentsForm = new _components_comments_form__WEBPACK_IMPORTED_MODULE_2__["default"]([]);
    ...
    this._provider = new _provider__WEBPACK_IMPORTED_MODULE_5__["default"]({api: this._api, store: this._store, isOnline: _utils_utils__WEBPACK_IMPORTED_MODULE_1__["isOnline"]});
  }
  ...
  _renderCommentsForm() {
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._commentsForm.getElement());
    this._commentsForm.removeElement();
    this._provider.getComments({id: this._id}).then((comments) => {
      this._commentsForm = new _components_comments_form__WEBPACK_IMPORTED_MODULE_2__["default"](comments);
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._container, this._commentsForm.getElement());
      ...
      if (!Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isOnline"])()) {
  ...
  _onEnterKeydown(evt) {
    if ((evt.key === `Enter` && evt.metaKey) || (evt.key === `Enter` && evt.ctrlKey)) {
      ...
      if (evt.target.classList.contains(_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].INPUT)) {
        evt.target.classList.remove(_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].INPUT);
      }
      ...
      this._api.postComment({id: this._id, data: _models_model_comment__WEBPACK_IMPORTED_MODULE_6__["default"].toRAW(newComment)})
        .then(() => {
          evt.target.disabled = false;
          evt.target.value = ``;
          evt.target.blur();
          checkedInputElement.checked = false;
          Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(chosenEmoji);
          this._onDataChange(this._id);
          this._renderCommentsForm();
        })
        .catch(() => {
          evt.target.disabled = false;
          evt.target.classList.add(_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].INPUT);
        });
    }
  }
...
class FilmController {
  ...
  init() {
    const hideFilmDetails = () => {
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._filmDetails.getElement());
    ...
    const onControlButtonClick = (evt) => {
      if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isButtonTag"])(evt.target.tagName)) {
        evt.preventDefault();
    ...
    const renderFilmDetails = () => {
      this._onChangeView();
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(document.body, this._filmDetails.getElement());
      renderCommentsForm();
    ...
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._container, this._filmCard.getElement());
  }
...
class MenuController {
  ...
  _renderMenu() {
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._menu.getElement());
    this._menu.removeElement();
    this._menu = new _components_menu__WEBPACK_IMPORTED_MODULE_2__["default"](this._cards);
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._container, this._menu.getElement(), _utils_constants__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN);
  ...
  _onFilterLinkClick(evt) {
    ...
    if (!Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isATag"])(evt.target.tagName)) {
      return;
    }
...
class PageController {
  constructor(container, onDataChange) {
    ...
    this._generalAmount = _utils_constants__WEBPACK_IMPORTED_MODULE_0__["GENERAL_FILMS_AMOUNT"];
  ...
  init() {
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._container, this._sort.getElement());
    this._sort.getElement().addEventListener(`click`, (evt) => this._onSortLinkClick(evt));
    this._sort.getElement().classList.add(`visually-hidden`);
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._container, this._films.getElement());
  }

  _renderGeneralFilmsList() {
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._generalFilmsList.getElement());
    this._generalFilmsList.removeElement();
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._films.getElement(), this._generalFilmsList.getElement(), _utils_constants__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN);
    ...
    if (!this._sortedCards.length) {
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._generalFilmsList.getElement(), this._noFilms.getElement());
    }
  }

  _renderCategoryFilmsLists() {
    if (this._cards.some((card) => Number(card.rating))) {
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._topRatedFilmsList.getElement());
      this._topRatedFilmsList.removeElement();
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._films.getElement(), this._topRatedFilmsList.getElement());
    ...
    if (this._cards.some((card) => Number(card.commentsAmount))) {
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._mostCommentedFilmsList.getElement());
      this._mostCommentedFilmsList.removeElement();
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._films.getElement(), this._mostCommentedFilmsList.getElement());
  ...
  _renderShowMoreButton() {
    if (this._sortedCards.length > this._generalAmount) {
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._showMoreButton.getElement());
      this._showMoreButton.removeElement();
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._generalFilmsList.getElement(), this._showMoreButton.getElement());
  ...
  _onShowMoreButtonClick() {
    ...
    this._filmCardsController.addFilmCards(this._sortedCards.slice(this._generalAmount, (this._generalAmount + _utils_constants__WEBPACK_IMPORTED_MODULE_0__["GENERAL_FILMS_AMOUNT"])));
    this._generalAmount += _utils_constants__WEBPACK_IMPORTED_MODULE_0__["GENERAL_FILMS_AMOUNT"];
    this._setFilmCards(this._sortedCards);
...
class SearchController {
  ...
  _showSearchResult(cards) {
    if (this._searchResult) {
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._searchResult.getElement());
      this._searchResult.removeElement();
    }

    if (cards.length) {
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._noResult.getElement());
      ...
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._container, this._searchResult.getElement());
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._container, this._filmsList.getElement());
      ...
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._filmsList.getElement());
      this._filmsList.removeElement();
      Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._container, this._noResult.getElement());
    }
  }
}
...
/* harmony import */ var _components_statistic_filters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/statistic-filters */ "./src/components/statistic-filters.js");
...
class StatisticsController {
  constructor(container) {
    ...
    this._cards = [];
    this._statistics = new _components_statistics__WEBPACK_IMPORTED_MODULE_1__["default"](this._cards);
    this._filters = new _components_statistic_filters__WEBPACK_IMPORTED_MODULE_2__["default"](this._cards);
  }
  ...
  _renderFilters(cards) {
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["removeElement"])(this._filters.getElement());
    this._filters.removeElement();
    this._filters = new _components_statistic_filters__WEBPACK_IMPORTED_MODULE_2__["default"](cards);
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(this._container, this._filters.getElement());
  ...
  _renderStatistics(cards) {
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["removeElement"])(this._statistics.getElement());
    this._statistics.removeElement();
    this._statistics = new _components_statistics__WEBPACK_IMPORTED_MODULE_1__["default"](cards);
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(this._filters.getElement(), this._statistics.getElement());
  }
  ...
  _renderCharts(cards) {
    ...
    const dataForChart = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["countDuplicateElements"])(watchedGenres);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UserRatingController; });
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/constants */ "./src/utils/constants.js");
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/utils */ "./src/utils/utils.js");
/* harmony import */ var _components_user_rating__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/user-rating */ "./src/components/user-rating.js");
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../api */ "./src/api.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store */ "./src/store.js");
/* harmony import */ var _provider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../provider */ "./src/provider.js");
/* harmony import */ var _models_model_card__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/model-card */ "./src/models/model-card.js");
...
class UserRatingController {
  constructor(container, card, onDataChange) {
    ...
    this._userRatingForm = new _components_user_rating__WEBPACK_IMPORTED_MODULE_2__["default"](this._card);
  ...
  _renderUserRatingForm() {
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(this._userRatingForm.getElement());
    this._userRatingForm.removeElement();
    this._userRatingForm = new _components_user_rating__WEBPACK_IMPORTED_MODULE_2__["default"](this._card);
    const ratingFormContainer = this._container.querySelector(`.form-details__middle-container`);
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(ratingFormContainer, this._userRatingForm.getElement());
  ...
  _onRatingInputChange(evt) {
    ...
    const errorInput = this._userRatingForm.getElement().querySelector(`.${_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].RATING_INPUT}`);

    if (errorInput) {
      errorInput.classList.remove(_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].RATING_INPUT);
    }

    if (this._userRatingForm.getElement().classList.contains(_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].RATING_FORM)) {
      this._userRatingForm.getElement().classList.remove(_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].RATING_FORM);
    }

    this._card.userRating = Number(evt.target.value);
    this._provider.updateCard({
      id: this._card.id,
      data: _models_model_card__WEBPACK_IMPORTED_MODULE_6__["default"].toRAW(this._card),
    })
      .then(() => {
      ...
      .catch(() => {
        ...
        ratingInputLabel.classList.add(_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].RATING_INPUT);
        this._userRatingForm.getElement().classList.add(_utils_constants__WEBPACK_IMPORTED_MODULE_0__["ErrorClasses"].RATING_FORM);
      });
  }
...
/* harmony import */ var _components_profile_rating__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/profile-rating */ "./src/components/profile-rating.js");
...
/* harmony import */ var _components_statistics_text__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/statistics-text */ "./src/components/statistics-text.js");
/* harmony import */ var _models_model_card__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./models/model-card */ "./src/models/model-card.js");
...
const provider = new _provider__WEBPACK_IMPORTED_MODULE_12__["default"]({api, store, isOnline: _utils_utils__WEBPACK_IMPORTED_MODULE_1__["isOnline"]});
...
const onDataChange = (update) => {
  provider.updateCard({
    id: update.id,
    data: _models_model_card__WEBPACK_IMPORTED_MODULE_10__["default"].toRAW(update),
  })
    .then(() => {
      provider.getCards()
        .then((updatedCards) => {
...
Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(headerElement, search.getElement());
Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(mainElement, loader.getElement());

const renderPage = ((cards) => {
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(loader.getElement());
  loader.removeElement();

  const profileRating = new _components_profile_rating__WEBPACK_IMPORTED_MODULE_7__["default"](cards);
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(headerElement.querySelector(`.profile`));
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(headerElement, profileRating.getElement());

  const statisticsText = new _components_statistics_text__WEBPACK_IMPORTED_MODULE_9__["default"](cards);
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(footerElement.querySelector(`.footer__statistics`));
  Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(footerElement, statisticsText.getElement());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ModelCard; });
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/utils */ "./src/utils/utils.js");
...
class ModelCard {
  constructor(data) {
    ...
    this.description = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["trimString"])(data[`film_info`][`description`]);
    ...
    this.details = {
      ...
      releaseDate: moment__WEBPACK_IMPORTED_MODULE_1___default()(data[`film_info`][`release`][`date`]).format(`DD MMMM YYYY`),
  ...
  static toRAW(card) {
    return {
      ...
      'user_details': {
        ...
        'watching_date': moment__WEBPACK_IMPORTED_MODULE_1___default()(card.watchingDate).toISOString() || moment__WEBPACK_IMPORTED_MODULE_1___default()().toISOString(),
...
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/utils */ "./src/utils/utils.js");
/* harmony import */ var _models_model_card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/model-card */ "./src/models/model-card.js");
/* harmony import */ var _models_model_comment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/model-comment */ "./src/models/model-comment.js");
  ...
  getCards() {
    if (this._isOnline()) {
      return this._api.getCards()
        .then((cards) => {
          cards.map((card) => this._store.setItem({key: card.id, item: _models_model_card__WEBPACK_IMPORTED_MODULE_1__["default"].toRAW(card)}));
          return cards;
        });
    }

    const rawCardsMap = this._store.getAll();
    const rawCards = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["objectToArray"])(rawCardsMap);
    const cards = _models_model_card__WEBPACK_IMPORTED_MODULE_1__["default"].parseCards(rawCards);
    return Promise.resolve(cards);
  }

  syncCards() {
    return this._api.syncCards({cards: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["objectToArray"])(this._store.getAll())});
  }
  ...
  updateCard({id, data}) {
    if (this._isOnline()) {
      return this._api.updateCard({id, data})
        .then((card) => {
          this._store.setItem({key: card.id, item: _models_model_card__WEBPACK_IMPORTED_MODULE_1__["default"].toRAW(card)});
          return card;
        });
    }
    ...
    return Promise.resolve(_models_model_card__WEBPACK_IMPORTED_MODULE_1__["default"].parseCard(card));
  }
  ...
  getComments({id}) {
    if (this._isOnline()) {
      return this._api.getComments({id})
        .then((comments) => {
          this._store.setItem({key: id, item: comments.map((comment) => _models_model_comment__WEBPACK_IMPORTED_MODULE_2__["default"].toRAW(comment))});
          return comments;
        });
    }

    const rawCommentsMap = this._store.getAll();
    const rawComments = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["objectToArray"])(rawCommentsMap);
    const comments = rawComments.map((rawComment) => {
      _models_model_comment__WEBPACK_IMPORTED_MODULE_2__["default"].parseComments(rawComment);
    });
...
/*!********************************!*\
  !*** ./src/utils/constants.js ***!
  \********************************/
/*! exports provided: GENERAL_FILMS_AMOUNT, CATEGORY_FILMS_AMOUNT, MIN_SEARCH_STRING_LENGTH, AUTHORIZATION, END_POINT, PING_URL, PING_TIMEOUT, CARDS_STORE_KEY, COMMENTS_STORE_KEY, Emojis, Description, UserRating, UserRatingChart, Position, TagNames, ListTitles, Sorting, Actions, Screens, States, Filters, Method, ErrorClasses */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GENERAL_FILMS_AMOUNT", function() { return GENERAL_FILMS_AMOUNT; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PING_URL", function() { return PING_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PING_TIMEOUT", function() { return PING_TIMEOUT; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserRatingChart", function() { return UserRatingChart; });
...
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
/*! exports provided: trimString, createElement, renderElement, removeElement, isValueInRange, getUserTitle, isATag, isButtonTag, countDuplicateElements, checkStatus, toJSON, isOnline, objectToArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isValueInRange", function() { return isValueInRange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getUserTitle", function() { return getUserTitle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isATag", function() { return isATag; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isButtonTag", function() { return isButtonTag; });
...
const trimString = (string) => {
  return string.length < _constants__WEBPACK_IMPORTED_MODULE_0__["Description"].LENGTH.MAX ? string : `${string.slice(0, _constants__WEBPACK_IMPORTED_MODULE_0__["Description"].LENGTH.TO_DISPLAY).trim()}…`;
};
...
const renderElement = (container, element, position = _constants__WEBPACK_IMPORTED_MODULE_0__["Position"].BEFOREEND) => {
  switch (position) {
...
const getUserTitle = (amount) => {
  ...
  for (const key of _constants__WEBPACK_IMPORTED_MODULE_0__["UserRatingChart"].keys()) {
    if (isValueInRange(amount, ...key)) {
      title = _constants__WEBPACK_IMPORTED_MODULE_0__["UserRatingChart"].get(key);
    }
  }

  return title;
};
const isATag = (tagName) => tagName === _constants__WEBPACK_IMPORTED_MODULE_0__["TagNames"].A;
const isButtonTag = (tagName) => tagName === _constants__WEBPACK_IMPORTED_MODULE_0__["TagNames"].BUTTON;
...
const isOnline = () => {
  let online;
  fetch(`${_constants__WEBPACK_IMPORTED_MODULE_0__["PING_URL"]}?_t=${_constants__WEBPACK_IMPORTED_MODULE_0__["PING_TIMEOUT"]}`)
    .then(() => {
      online = true;
      return online;
    })
